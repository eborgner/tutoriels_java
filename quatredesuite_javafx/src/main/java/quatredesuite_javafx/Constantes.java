...
public class Constantes {
    ...
    public static final int LARGEUR_SCENE_PETIT = 400;
    public static final int HAUTEUR_SCENE_PETIT = 300;

    public static final int LARGEUR_SCENE_GRAND = 800;
    public static final int HAUTEUR_SCENE_GRAND = 600;
    
    
    public static final int LARGEUR_SCENE= LARGEUR_SCENE_PETIT;
    public static final int HAUTEUR_SCENE = HAUTEUR_SCENE_PETIT;
